	...
	<div class="col-md-8">
		<div class="card">
	        <div class="card-header">
	          <h2> Nuevo tipo sangre <a href="{{ route('tipo_sangre.index') }}" class="btn btn-primary float-right" data-toggle="tooltip" title="¡Desde aquí puedes volver a la lista tipos sangre!" data-placement="right">Atrás</a>
	          </h2>
	        </div>
				{{-- @include('Cliente.frangment.error') --}}
		   		{{-- @include('Cliente.frangment.info') --}}
	        <div class="card-body">					
	        	<form method="POST" action="{{ route('tipo_sangre.store') }}"  role="form">
					{{ csrf_field() }}
