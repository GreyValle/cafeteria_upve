  ...
  <div class="col-md-10">
    <div class="card">
          <div class="card-header">
            <h2>Editando escolaridad <a href="{{ route('escolaridad.index') }}" class="btn btn-primary float-right" data-toggle="tooltip" title="¡Desde aquí puedes volver a la lista de escolaridad!" data-placement="left">Atrás</a>
            </h2>
          </div>
