  ...
  <div class="row justify-content-center">
	<div class="col-lg-12">
		<div class="card">
	        ...
	        <div class="card-body">					
	        	<form method="POST" action="{{ route('clientes.update') }}"  role="form">
					{{ csrf_field() }}
					<div class="row">		
						...
						<div class="form-group col-md-6">
							...
							<input type="email" name="email" id="email" class="form-control input-sm" placeholder="Ingresa correo válido">
						</div>
						
						<div class="form-group col-md-6">
							<label for="direccion">Dirección:</label>
							<textarea name="direccion" id="direccion" class="form-control input-sm" placeholder="Ingresar una dirección correcta"></textarea>
						</div>

						<div class="form-group col-md-6">
							<label for="email">Fecha Nacimiento:</label>
							<input type="date" name="fecha_nac" id="fecha_nac" class="form-control input-sm" placeholder="Ingresa fecha nacimiento">
						</div>
								
						<div class="form-group col-md-6">
							<label for="telefono">Teléfono:</label>
							<input type="text" name="telefono" id="telefono" class="form-control input-sm" placeholder="Número de telefono del cliente">
						</div>
					...
					<div class="row">			
						...
						<div class="form-group col-md-6">
							...
							{{-- <input type="text" name="sexo" id="sexo" class="form-control input-sm" placeholder="Ingresar el sexo del cliente"> --}}
						  <select class="custom-select" id="estatus_social" name="estatus_social">
					...
					<input type="submit"  value="Guardar" class="btn btn-success float-right" data-toggle="tooltip" title="¡Este boton en para guardar!" data-placement="left">
